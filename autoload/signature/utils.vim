...
function! signature#utils#Maps(mode)                                                                              " {{{1
  ...
  call s:Map(a:mode, 'PurgeMarks'       , l:SignatureMapLeader . "-"      , 'mark#Purge("all")'                   )
  ...
  call s:Map(a:mode, 'GotoNextSpotAlpha', "m]"                            , 'mark#Goto("next", "spot", "alpha")'  )
  call s:Map(a:mode, 'GotoPrevSpotAlpha', "m["                            , 'mark#Goto("prev", "spot", "alpha")'  )
